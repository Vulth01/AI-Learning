...
public class NN : MonoBehaviour
{
    ...
    */
    ...
    which is the decision of the network, in this case, the direction to move in.
    */
    public float[] Brain(float[] inputs)
    {
        for (int i = 0; i < layers.Length; i++)
        {
            ...
            else if (i == layers.Length - 1)                    //final output layer, don't want an activation function for this
            {
                layers[i].Forward(layers[i - 1].nodeArray); 
            }
            else                                                //any amount of hidden layers between input and output layer
            {
                layers[i].Forward(layers[i - 1].nodeArray);
                layers[i].Activation();
            }
    ...
    public class Layer
    {
        ...
        /*
        constructor, this is called when we create a new layer, 
        it sets the number of inputs and nodes, and creates the arrays.
        */
        ...
        /*
        forward pass, takes in an array of inputs and returns an array of outputs,
        which is then used as the input for the next layer, and so on,
        until we get to the output layer, which is returned as the output of the network. 
        */
